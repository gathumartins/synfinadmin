...
const CreateSaccoBranch =({match, title}) => {
    return(
        <div className="animated slideInUpTiny animation-duration-3">
            <div className="dashboard animated slideInUpTiny animation-duration-3">
                <ContainerHeader match={match} title={<IntlMessages id="sidebar.adminManagement.SaccoManagement.AddSaccoBranch" />} />
            </div>
            <section className="jr-card">
                <form className="row">
                    ...
                    <div className="col-12">
                        <div className="btn btn-primary btn-lg float-right">Add Sacco Branch</div>
                    </div>
                </form>
            </section>
        </div>
...
export default CreateSaccoBranch;